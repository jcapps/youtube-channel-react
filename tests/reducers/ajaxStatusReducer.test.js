...
describe('Ajax Status Reducer', () => {
    ...
    it('Should increase about and header ajaxCallsInProgress when passed GETTING_CHANNEL_INFO', () => {
        // arrange
    ...
    it('Should decrease about and header ajaxCallsInProgress when passed GET_CHANNEL_INFO_SUCCESS', () => {
        // arrange
